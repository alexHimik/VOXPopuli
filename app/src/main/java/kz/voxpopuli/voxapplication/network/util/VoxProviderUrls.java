...
//public static final String SEARCH_REQUEST = "http://www.voxpopuli.kz/exec/test.php";

    public static final String SIGN_IN_REQUEST = "http://www.voxpopuli.kz/api/sign_in.json";
//public static final String SIGN_IN_REQUEST = "http://www.voxpopuli.kz/exec/test.php";

    public static final String TEST = "http://dev.iwantineed.com/en/user/test-api-post";
}
